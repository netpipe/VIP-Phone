...
private slots:
    ...
    void startAudioStreaming() {
        if (pushToTalk->isChecked()) {
            ...
            connect(audioInputDevice, &QIODevice::readyRead, this, &VoIPClient::sendAudioData);
        }
    }

    void stopAudioStreaming() {
        if (pushToTalk->isChecked()) {
            disconnect(audioInputDevice, &QIODevice::readyRead, this, &VoIPClient::sendAudioData);
            audioInput->stop();
        }
    }
